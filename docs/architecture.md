...
- **Ира** — разработчик и одновременно клиент Анны. Это особый случай (раздел 1b ТЗ): её сессии используются как учебный материал только когда Анна явно их «закроет», и не раньше N месяцев после записи.
